...
public class update {
	@Keyword
	public void updateShops(String status, int id) {
		...
		def sql="UPDATE SHOPS SET test_status='"+status+"' where id="+id
		println sql
		//CustomKeywords.'com.katalon.plugin.keyword.connection.DatabaseKeywords.execute'(globalConnection,sql)
